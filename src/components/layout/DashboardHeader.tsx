                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        ...
                        <Link href="/">
                            <Button
                                variant="ghost"
                                size="sm"
                                className="group hover:bg-gradient-to-r hover:from-[var(--primary-50)] hover:to-[var(--primary-100)] border border-transparent hover:border-[var(--primary-200)] transition-all duration-300"
                            >
